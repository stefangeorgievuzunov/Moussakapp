...
public class AddRecipeFragment extends DialogFragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recipeDescription = view.findViewById(R.id.recipeDescriptionFragment);
        recipeImg = view.findViewById(R.id.recipeImageFragment);
    ...
    public void onClick(View v) {
        Recipe recipe=new Recipe(recipeName.getText().toString(),recipeDescription.getText().toString(),recipeImgUrl,1);
